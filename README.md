...
✔️ Search for products by name or keywords
✔️ Recommends top 10 products based on textual similarity and normalized rating
✔️ Integrates Word2Vec embeddings for semantic matching
✔️ Uses a Flask web front‑end to display results
